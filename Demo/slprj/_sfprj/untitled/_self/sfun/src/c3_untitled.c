...
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_imopen(SFc3_untitledInstanceStruct *chartInstance, boolean_T
                      c3_d_A[307200],
                      c3_images_internal_coder_strel_StructuringElementHelper
                      *c3_se_, boolean_T c3_B[307200]);
static void c3_imerode(SFc3_untitledInstanceStruct *chartInstance, boolean_T
  c3_d_A[307200], c3_images_internal_coder_strel_StructuringElementHelper *c3_se,
  boolean_T c3_B[307200]);
static void c3_padarray(SFc3_untitledInstanceStruct *chartInstance, boolean_T
  c3_varargin_1[307200], boolean_T c3_b[309444]);
static void c3_bwpack(SFc3_untitledInstanceStruct *chartInstance, boolean_T
                      c3_varargin_1[311696], uint32_T c3_BWP[10304]);
static void c3_bwunpack(SFc3_untitledInstanceStruct *chartInstance, uint32_T
  c3_varargin_1[10304], boolean_T c3_d_BW[311696]);
static void c3_b_padarray(SFc3_untitledInstanceStruct *chartInstance, boolean_T
  c3_varargin_1[307200], boolean_T c3_b[309444]);
  ...
  const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_untitled = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_b_u, 1)), "is_active_c3_untitled");
...
static const mxArray *sf_get_sim_state_info_c3_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Im\",},{M[8],M[0],T\"is_active_c3_untitled\",}}"
  };
