#ifndef __Demo_sfun_h__
#define __Demo_sfun_h__
...
extern uint32_T _DemoMachineNumber_;
...
extern mxArray* load_Demo_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_Demo_optimization_info(void);
