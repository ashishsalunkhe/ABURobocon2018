...
static void initialize_c4_Demo(SFc4_DemoInstanceStruct *chartInstance);
static void initialize_params_c4_Demo(SFc4_DemoInstanceStruct *chartInstance);
static void enable_c4_Demo(SFc4_DemoInstanceStruct *chartInstance);
static void disable_c4_Demo(SFc4_DemoInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_Demo(SFc4_DemoInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_Demo(SFc4_DemoInstanceStruct
  *chartInstance);
static void set_sim_state_c4_Demo(SFc4_DemoInstanceStruct *chartInstance, const
  mxArray *c4_st);
static void finalize_c4_Demo(SFc4_DemoInstanceStruct *chartInstance);
static void sf_gateway_c4_Demo(SFc4_DemoInstanceStruct *chartInstance);
static void mdl_start_c4_Demo(SFc4_DemoInstanceStruct *chartInstance);
static void initSimStructsc4_Demo(SFc4_DemoInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_DemoInstanceStruct *chartInstance, const
  mxArray *c4_c_Im, const char_T *c4_identifier, boolean_T c4_b_y[307200]);
static void c4_b_emlrt_marshallIn(SFc4_DemoInstanceStruct *chartInstance, const
  mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId, boolean_T c4_b_y
  [307200]);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_DemoInstanceStruct *chartInstance,
  const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_imopen(SFc4_DemoInstanceStruct *chartInstance, boolean_T c4_d_A
                      [307200],
                      c4_images_internal_coder_strel_StructuringElementHelper
                      *c4_se_, boolean_T c4_B[307200]);
static void c4_imerode(SFc4_DemoInstanceStruct *chartInstance, boolean_T c4_d_A
  [307200], c4_images_internal_coder_strel_StructuringElementHelper *c4_se,
  boolean_T c4_B[307200]);
static void c4_padarray(SFc4_DemoInstanceStruct *chartInstance, boolean_T
  c4_varargin_1[307200], boolean_T c4_b[309444]);
static void c4_bwpack(SFc4_DemoInstanceStruct *chartInstance, boolean_T
                      c4_varargin_1[311696], uint32_T c4_BWP[10304]);
static void c4_bwunpack(SFc4_DemoInstanceStruct *chartInstance, uint32_T
  c4_varargin_1[10304], boolean_T c4_d_BW[311696]);
static void c4_b_padarray(SFc4_DemoInstanceStruct *chartInstance, boolean_T
  c4_varargin_1[307200], boolean_T c4_b[309444]);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_DemoInstanceStruct *chartInstance,
  const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_DemoInstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_Demo, const char_T *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_DemoInstanceStruct *chartInstance,
  const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_DemoInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc4_DemoInstanceStruct *chartInstance);
...
static void initialize_c4_Demo(SFc4_DemoInstanceStruct *chartInstance)
{
  ...
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc4_Demo(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c4_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c4_is_active_c4_Demo = 0U;
}
  ...
  *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_Demo;
  c4_d_y = NULL;
  ...
  mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_Demo = c4_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_b_u, 1)), "is_active_c4_Demo");
  sf_mex_destroy(&c4_b_u);
  c4_update_debugger_state_c4_Demo(chartInstance);
...
static void sf_gateway_c4_Demo(SFc4_DemoInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_DemoMachineNumber_,
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_b_y = NULL;
  int32_T c4_i10;
  SFc4_DemoInstanceStruct *chartInstance;
  chartInstance = (SFc4_DemoInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_Demo_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c4_b_is_active_c4_Demo, const char_T *c4_identifier)
{
  ...
  c4_b_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_Demo), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_Demo);
  return c4_b_y;
}
...
void sf_c4_Demo_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_Demo_get_post_codegen_info(void);
mxArray *sf_c4_Demo_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_Demo_get_post_codegen_info();
...
mxArray *sf_c4_Demo_third_party_uses_info(void)
{
...
mxArray *sf_c4_Demo_jit_fallback_info(void)
{
...
mxArray *sf_c4_Demo_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_Demo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Im\",},{M[8],M[0],T\"is_active_c4_Demo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Demo_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_DemoInstanceStruct *chartInstance = (SFc4_DemoInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_DemoMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_DemoMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _DemoMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c4_Demo(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_DemoInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c4_Demo((SFc4_DemoInstanceStruct*) chartInstanceVar);
  initialize_c4_Demo((SFc4_DemoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_Demo(void *chartInstanceVar)
{
  enable_c4_Demo((SFc4_DemoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_Demo(void *chartInstanceVar)
{
  disable_c4_Demo((SFc4_DemoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_Demo(void *chartInstanceVar)
{
  sf_gateway_c4_Demo((SFc4_DemoInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_Demo(SimStruct* S)
{
  return get_sim_state_c4_Demo((SFc4_DemoInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_Demo(SimStruct* S, const mxArray *st)
{
  set_sim_state_c4_Demo((SFc4_DemoInstanceStruct*)sf_get_chart_instance_ptr(S),
                        st);
}

static void sf_opaque_terminate_c4_Demo(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_DemoInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Demo_optimization_info();
    }

    finalize_c4_Demo((SFc4_DemoInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_Demo((SFc4_DemoInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_Demo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_Demo((SFc4_DemoInstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

static void mdlSetWorkWidths_c4_Demo(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Demo_optimization_info(sim_mode_is_rtw_gen(S),
...
static void mdlRTW_c4_Demo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_Demo(SimStruct *S)
{
  SFc4_DemoInstanceStruct *chartInstance;
  chartInstance = (SFc4_DemoInstanceStruct *)utMalloc(sizeof
    (SFc4_DemoInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc4_DemoInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_Demo;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_Demo;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_Demo;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_Demo;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_Demo;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_Demo;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_Demo;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_Demo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_Demo;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_Demo;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_Demo;
  ...
  mdl_start_c4_Demo(chartInstance);
}

void c4_Demo_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Demo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Demo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Demo_method_dispatcher.\n"
