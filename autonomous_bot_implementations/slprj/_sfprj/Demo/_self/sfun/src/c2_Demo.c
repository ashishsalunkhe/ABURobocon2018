...
static void initialize_c2_Demo(SFc2_DemoInstanceStruct *chartInstance);
static void initialize_params_c2_Demo(SFc2_DemoInstanceStruct *chartInstance);
static void enable_c2_Demo(SFc2_DemoInstanceStruct *chartInstance);
static void disable_c2_Demo(SFc2_DemoInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Demo(SFc2_DemoInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_Demo(SFc2_DemoInstanceStruct
  *chartInstance);
static void set_sim_state_c2_Demo(SFc2_DemoInstanceStruct *chartInstance, const
  mxArray *c2_st);
static void finalize_c2_Demo(SFc2_DemoInstanceStruct *chartInstance);
static void sf_gateway_c2_Demo(SFc2_DemoInstanceStruct *chartInstance);
static void mdl_start_c2_Demo(SFc2_DemoInstanceStruct *chartInstance);
static void c2_chartstep_c2_Demo(SFc2_DemoInstanceStruct *chartInstance);
static void initSimStructsc2_Demo(SFc2_DemoInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_DemoInstanceStruct *chartInstance, const
  mxArray *c2_c_BW, const char_T *c2_identifier, boolean_T c2_c_y[307200]);
static void c2_b_emlrt_marshallIn(SFc2_DemoInstanceStruct *chartInstance, const
  mxArray *c2_c_u, const emlrtMsgIdentifier *c2_parentId, boolean_T c2_c_y
  [307200]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_DemoInstanceStruct *chartInstance,
  const mxArray *c2_c_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_d_emlrt_marshallIn(SFc2_DemoInstanceStruct *chartInstance, const
  mxArray *c2_c_u, const emlrtMsgIdentifier *c2_parentId, real32_T c2_c_y[921600]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_DemoInstanceStruct *chartInstance,
  const mxArray *c2_c_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_DemoInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_Demo, const char_T *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_DemoInstanceStruct *chartInstance,
  const mxArray *c2_c_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_DemoInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_DemoInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c2_Demo(SFc2_DemoInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_Demo(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c2_is_active_c2_Demo = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_Demo;
  c2_e_y = NULL;
  ...
  mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_Demo = c2_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_c_u, 1)), "is_active_c2_Demo");
  sf_mex_destroy(&c2_c_u);
  c2_update_debugger_state_c2_Demo(chartInstance);
...
static void sf_gateway_c2_Demo(SFc2_DemoInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Demo(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_c_y = NULL;
  int32_T c2_i29;
  SFc2_DemoInstanceStruct *chartInstance;
  chartInstance = (SFc2_DemoInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_Demo_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_Demo, const char_T *c2_identifier)
{
  ...
  c2_c_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Demo), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Demo);
  return c2_c_y;
}
...
void sf_c2_Demo_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_Demo_get_post_codegen_info(void);
mxArray *sf_c2_Demo_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_Demo_get_post_codegen_info();
...
mxArray *sf_c2_Demo_third_party_uses_info(void)
{
...
mxArray *sf_c2_Demo_jit_fallback_info(void)
{
...
mxArray *sf_c2_Demo_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_Demo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"BW\",},{M[8],M[0],T\"is_active_c2_Demo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Demo_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_DemoInstanceStruct *chartInstance = (SFc2_DemoInstanceStruct *)
...
static void sf_opaque_initialize_c2_Demo(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_DemoInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c2_Demo((SFc2_DemoInstanceStruct*) chartInstanceVar);
  initialize_c2_Demo((SFc2_DemoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_Demo(void *chartInstanceVar)
{
  enable_c2_Demo((SFc2_DemoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_Demo(void *chartInstanceVar)
{
  disable_c2_Demo((SFc2_DemoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_Demo(void *chartInstanceVar)
{
  sf_gateway_c2_Demo((SFc2_DemoInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_Demo(SimStruct* S)
{
  return get_sim_state_c2_Demo((SFc2_DemoInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Demo(SimStruct* S, const mxArray *st)
{
  set_sim_state_c2_Demo((SFc2_DemoInstanceStruct*)sf_get_chart_instance_ptr(S),
                        st);
}

static void sf_opaque_terminate_c2_Demo(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_DemoInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Demo_optimization_info();
    }

    finalize_c2_Demo((SFc2_DemoInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_Demo((SFc2_DemoInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Demo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_Demo((SFc2_DemoInstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

static void mdlSetWorkWidths_c2_Demo(SimStruct *S)
{
...
static void mdlRTW_c2_Demo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Demo(SimStruct *S)
{
  SFc2_DemoInstanceStruct *chartInstance;
  chartInstance = (SFc2_DemoInstanceStruct *)utMalloc(sizeof
    (SFc2_DemoInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_DemoInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_Demo;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_Demo;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_Demo;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Demo;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_Demo;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_Demo;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_Demo;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_Demo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Demo;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Demo;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_Demo;
  ...
  mdl_start_c2_Demo(chartInstance);
}

void c2_Demo_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Demo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Demo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Demo_method_dispatcher.\n"
