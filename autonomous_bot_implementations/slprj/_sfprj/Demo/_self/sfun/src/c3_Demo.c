...
static void initialize_c3_Demo(SFc3_DemoInstanceStruct *chartInstance);
static void initialize_params_c3_Demo(SFc3_DemoInstanceStruct *chartInstance);
static void enable_c3_Demo(SFc3_DemoInstanceStruct *chartInstance);
static void disable_c3_Demo(SFc3_DemoInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Demo(SFc3_DemoInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_Demo(SFc3_DemoInstanceStruct
  *chartInstance);
static void set_sim_state_c3_Demo(SFc3_DemoInstanceStruct *chartInstance, const
  mxArray *c3_st);
static void finalize_c3_Demo(SFc3_DemoInstanceStruct *chartInstance);
static void sf_gateway_c3_Demo(SFc3_DemoInstanceStruct *chartInstance);
static void mdl_start_c3_Demo(SFc3_DemoInstanceStruct *chartInstance);
static void initSimStructsc3_Demo(SFc3_DemoInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_DemoInstanceStruct *chartInstance, const
  mxArray *c3_c_Im, const char_T *c3_identifier, boolean_T c3_b_y[307200]);
static void c3_b_emlrt_marshallIn(SFc3_DemoInstanceStruct *chartInstance, const
  mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId, boolean_T c3_b_y
  [307200]);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_DemoInstanceStruct *chartInstance,
  const mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_imopen(SFc3_DemoInstanceStruct *chartInstance, boolean_T c3_d_A
                      [307200],
                      c3_images_internal_coder_strel_StructuringElementHelper
                      *c3_se_, boolean_T c3_B[307200]);
static void c3_imerode(SFc3_DemoInstanceStruct *chartInstance, boolean_T c3_d_A
  [307200], c3_images_internal_coder_strel_StructuringElementHelper *c3_se,
  boolean_T c3_B[307200]);
static void c3_padarray(SFc3_DemoInstanceStruct *chartInstance, boolean_T
  c3_varargin_1[307200], boolean_T c3_b[309444]);
static void c3_bwpack(SFc3_DemoInstanceStruct *chartInstance, boolean_T
                      c3_varargin_1[311696], uint32_T c3_BWP[10304]);
static void c3_bwunpack(SFc3_DemoInstanceStruct *chartInstance, uint32_T
  c3_varargin_1[10304], boolean_T c3_d_BW[311696]);
static void c3_b_padarray(SFc3_DemoInstanceStruct *chartInstance, boolean_T
  c3_varargin_1[307200], boolean_T c3_b[309444]);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_DemoInstanceStruct *chartInstance,
  const mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_DemoInstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_Demo, const char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_DemoInstanceStruct *chartInstance,
  const mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_DemoInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc3_DemoInstanceStruct *chartInstance);
...
static void initialize_c3_Demo(SFc3_DemoInstanceStruct *chartInstance)
{
  ...
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc3_Demo(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c3_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c3_is_active_c3_Demo = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_Demo;
  c3_d_y = NULL;
  ...
  mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_Demo = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_b_u, 1)), "is_active_c3_Demo");
  sf_mex_destroy(&c3_b_u);
  c3_update_debugger_state_c3_Demo(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_b_y = NULL;
  int32_T c3_i10;
  SFc3_DemoInstanceStruct *chartInstance;
  chartInstance = (SFc3_DemoInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_Demo_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c3_b_is_active_c3_Demo, const char_T *c3_identifier)
{
  ...
  c3_b_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Demo), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Demo);
  return c3_b_y;
}
...
void sf_c3_Demo_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_Demo_get_post_codegen_info(void);
mxArray *sf_c3_Demo_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_Demo_get_post_codegen_info();
...
mxArray *sf_c3_Demo_third_party_uses_info(void)
{
...
mxArray *sf_c3_Demo_jit_fallback_info(void)
{
...
mxArray *sf_c3_Demo_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_Demo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Im\",},{M[8],M[0],T\"is_active_c3_Demo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Demo_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_DemoInstanceStruct *chartInstance = (SFc3_DemoInstanceStruct *)
...
static void sf_opaque_initialize_c3_Demo(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_DemoInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c3_Demo((SFc3_DemoInstanceStruct*) chartInstanceVar);
  initialize_c3_Demo((SFc3_DemoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_Demo(void *chartInstanceVar)
{
  enable_c3_Demo((SFc3_DemoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_Demo(void *chartInstanceVar)
{
  disable_c3_Demo((SFc3_DemoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_Demo(void *chartInstanceVar)
{
  sf_gateway_c3_Demo((SFc3_DemoInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_Demo(SimStruct* S)
{
  return get_sim_state_c3_Demo((SFc3_DemoInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_Demo(SimStruct* S, const mxArray *st)
{
  set_sim_state_c3_Demo((SFc3_DemoInstanceStruct*)sf_get_chart_instance_ptr(S),
                        st);
}

static void sf_opaque_terminate_c3_Demo(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_DemoInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Demo_optimization_info();
    }

    finalize_c3_Demo((SFc3_DemoInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_Demo((SFc3_DemoInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Demo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_Demo((SFc3_DemoInstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

static void mdlSetWorkWidths_c3_Demo(SimStruct *S)
{
...
static void mdlRTW_c3_Demo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Demo(SimStruct *S)
{
  SFc3_DemoInstanceStruct *chartInstance;
  chartInstance = (SFc3_DemoInstanceStruct *)utMalloc(sizeof
    (SFc3_DemoInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc3_DemoInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_Demo;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_Demo;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_Demo;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_Demo;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_Demo;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_Demo;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_Demo;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_Demo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Demo;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_Demo;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_Demo;
  ...
  mdl_start_c3_Demo(chartInstance);
}

void c3_Demo_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Demo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Demo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Demo_method_dispatcher.\n"
