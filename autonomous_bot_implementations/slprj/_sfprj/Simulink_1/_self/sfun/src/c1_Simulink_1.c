...
static void initialize_c1_Simulink_1(SFc1_Simulink_1InstanceStruct
  *chartInstance);
static void initialize_params_c1_Simulink_1(SFc1_Simulink_1InstanceStruct
  *chartInstance);
static void enable_c1_Simulink_1(SFc1_Simulink_1InstanceStruct *chartInstance);
static void disable_c1_Simulink_1(SFc1_Simulink_1InstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Simulink_1(SFc1_Simulink_1InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_Simulink_1(SFc1_Simulink_1InstanceStruct *
  chartInstance);
static void set_sim_state_c1_Simulink_1(SFc1_Simulink_1InstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_Simulink_1(SFc1_Simulink_1InstanceStruct *chartInstance);
static void sf_gateway_c1_Simulink_1(SFc1_Simulink_1InstanceStruct
  *chartInstance);
static void mdl_start_c1_Simulink_1(SFc1_Simulink_1InstanceStruct *chartInstance);
static void c1_chartstep_c1_Simulink_1(SFc1_Simulink_1InstanceStruct
  *chartInstance);
static void initSimStructsc1_Simulink_1(SFc1_Simulink_1InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_Simulink_1InstanceStruct *chartInstance,
  const mxArray *c1_c_BW, const char_T *c1_identifier, boolean_T c1_c_y[307200]);
static void c1_b_emlrt_marshallIn(SFc1_Simulink_1InstanceStruct *chartInstance,
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_Simulink_1InstanceStruct *chartInstance,
  const mxArray *c1_c_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_d_emlrt_marshallIn(SFc1_Simulink_1InstanceStruct *chartInstance,
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_e_emlrt_marshallIn(SFc1_Simulink_1InstanceStruct
  *chartInstance, const mxArray *c1_c_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_f_emlrt_marshallIn(SFc1_Simulink_1InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_Simulink_1, const char_T
  *c1_identifier);
static uint8_T c1_g_emlrt_marshallIn(SFc1_Simulink_1InstanceStruct
  *chartInstance, const mxArray *c1_c_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_Simulink_1InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc1_Simulink_1InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc1_Simulink_1(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c1_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c1_is_active_c1_Simulink_1 = 0U;
}
  ...
  chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_Simulink_1;
  c1_e_y = NULL;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_Simulink_1 = c1_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_c_u, 1)),
     "is_active_c1_Simulink_1");
  sf_mex_destroy(&c1_c_u);
  c1_update_debugger_state_c1_Simulink_1(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_Simulink_1(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_c_y = NULL;
  int32_T c1_i29;
  SFc1_Simulink_1InstanceStruct *chartInstance;
  chartInstance = (SFc1_Simulink_1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_Simulink_1_get_eml_resolved_functions_info(void)
{
  ...
  *c1_identifier)
{
  ...
  c1_c_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Simulink_1), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Simulink_1);
  return c1_c_y;
}
...
void sf_c1_Simulink_1_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_Simulink_1_get_post_codegen_info(void);
mxArray *sf_c1_Simulink_1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_Simulink_1_get_post_codegen_info();
...
mxArray *sf_c1_Simulink_1_third_party_uses_info(void)
{
...
mxArray *sf_c1_Simulink_1_jit_fallback_info(void)
{
...
mxArray *sf_c1_Simulink_1_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_Simulink_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"BW\",},{M[8],M[0],T\"is_active_c1_Simulink_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Simulink_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_Simulink_1InstanceStruct *chartInstance =
      (SFc1_Simulink_1InstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c1_Simulink_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Simulink_1InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_Simulink_1((SFc1_Simulink_1InstanceStruct*)
    chartInstanceVar);
  initialize_c1_Simulink_1((SFc1_Simulink_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Simulink_1(void *chartInstanceVar)
{
  enable_c1_Simulink_1((SFc1_Simulink_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Simulink_1(void *chartInstanceVar)
{
  disable_c1_Simulink_1((SFc1_Simulink_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Simulink_1(void *chartInstanceVar)
{
  sf_gateway_c1_Simulink_1((SFc1_Simulink_1InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_Simulink_1(SimStruct* S)
{
  return get_sim_state_c1_Simulink_1((SFc1_Simulink_1InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_Simulink_1(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c1_Simulink_1((SFc1_Simulink_1InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c1_Simulink_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Simulink_1InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Simulink_1_optimization_info();
    }

    finalize_c1_Simulink_1((SFc1_Simulink_1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_Simulink_1((SFc1_Simulink_1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Simulink_1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Simulink_1(SimStruct *S)
{
...
static void mdlRTW_c1_Simulink_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Simulink_1(SimStruct *S)
{
  SFc1_Simulink_1InstanceStruct *chartInstance;
  chartInstance = (SFc1_Simulink_1InstanceStruct *)utMalloc(sizeof
    (SFc1_Simulink_1InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc1_Simulink_1InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_Simulink_1;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_Simulink_1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_Simulink_1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_Simulink_1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_Simulink_1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_Simulink_1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_Simulink_1;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_Simulink_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Simulink_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Simulink_1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_Simulink_1;
  ...
  mdl_start_c1_Simulink_1(chartInstance);
}

void c1_Simulink_1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Simulink_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Simulink_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Simulink_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Simulink_1_method_dispatcher.\n"
