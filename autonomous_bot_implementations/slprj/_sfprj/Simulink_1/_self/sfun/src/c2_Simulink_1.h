#ifndef __c2_Simulink_1_h__
#define __c2_Simulink_1_h__

/* Type Definitions */
#ifndef typedef_SFc2_Simulink_1InstanceStruct
#define typedef_SFc2_Simulink_1InstanceStruct
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_Simulink_1;
...
#endif                                 /*typedef_SFc2_Simulink_1InstanceStruct*/
...
extern const mxArray *sf_c2_Simulink_1_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c2_Simulink_1_get_check_sum(mxArray *plhs[]);
extern void c2_Simulink_1_method_dispatcher(SimStruct *S, int_T method, void
  *data);
